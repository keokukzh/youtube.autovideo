import type { User, Generation, Credits, ContentOutputs } from '@/lib/types';
...
export const mockContentOutputs: ContentOutputs = {
  twitter_posts: [
...
export const mockGenerations: Generation[] = [
  mockGeneration,
  {
    ...
    input_url: 'https://youtube.com/watch?v=test2',
    status: 'pending',
    outputs: mockContentOutputs,
  },
  {
    ...mockGeneration,
    id: 'test-generation-id-3',
    input_url: 'https://youtube.com/watch?v=test3',
    status: 'failed',
    outputs: mockContentOutputs,
  },
];
...
export const mockApiResponses = {
  ...
  generation: {
    ...
    data: {
      ...
      status: 'pending',
      poll_url: `/api/generation/${mockGeneration.id}`,
    },
...
export const mockFormData = {
  ...
  text: {
    input_type: 'text',
    input_text: 'This is a test text input for content generation.',
  },
  audio: {
    input_type: 'audio',
    file: new File(['test audio content'], 'test.mp3', { type: 'audio/mpeg' }),
  },
};
